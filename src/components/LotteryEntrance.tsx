...
// TODO: add in recentWinner event and update the client 
...
export default function LotteryEntrance() {
    ...
    return (
        <div className="p-5">
            <p className="text-xl">Welcome to Smart Contract Lottery. Enter the raffle with a single button click!</p>
            {raffleAddress ? (
                <div className="">
                    <button
                        ...
                        onClick={async function () {
                            await enterRaffle({
                                ...
                                onError: (error) => console.log('Error has occurred', error)
                            })
                        }}
                        disabled={isLoading || isFetching}
                    >
                        {isLoading || isFetching ? (
                            <div className="animate-spin spinner-border h-8 w-8 border-b-2 rounded-full">Pending</div>
                        ) : (
